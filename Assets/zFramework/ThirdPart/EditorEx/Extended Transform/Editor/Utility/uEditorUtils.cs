...
public static class uEditorUtils
{
    ...
    public static GUISkin uEditorSkin
    {
        get
        {
            if (guiSkin == null)
            {
                guiSkin = AssetDatabasex.LoadAssetOfType<GUISkin>("uEditorGUI");
            }
            return guiSkin;
        }
    }
    ...
    private static Texture2D xIcon
    {
        get
        {
            if (_xIcon == null) _xIcon = AssetDatabasex.LoadAssetOfType<Texture2D>("uEditor_X"); 
            return _xIcon;
        }
    }
    ...
    private static Texture2D yIcon
    {
        get
        {
            if (_yIcon == null) _yIcon = AssetDatabasex.LoadAssetOfType<Texture2D>("uEditor_Y");
            return _yIcon;
        }
    }
    ...
    private static Texture2D zIcon
    {
        get
        {
            if (_zIcon == null) _zIcon = AssetDatabasex.LoadAssetOfType<Texture2D>("uEditor_Z"); 
            return _zIcon;
        }
    }
