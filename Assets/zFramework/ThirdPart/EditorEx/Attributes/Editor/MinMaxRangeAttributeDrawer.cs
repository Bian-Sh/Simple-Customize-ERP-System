...
{
    float cachedMinValue = float.MinValue;
    float cachedMaxValue = float.MinValue ;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
        ...
        if (cachedMaxValue !=maxValue||cachedMinValue!=minValue)
        {
            float cachedMinValue = minValue;
            float cachedMaxValue = maxValue;
